...
This tutorial is based on the topics covered in the [[https://www.cl.cam.ac.uk/teaching/0910/UnixTools/make.pdf][GNU Make]] book. This tutorial teaches mainly through examples in order to help quickly explain the concepts in the book.
...
** Magic Implicit Commands 隐含规划 (Section 2.5)
...
** Using Wildcard Characters 使用通配符 (Section 4.2)
...
** The all target 使用all target (Section 4.4)
